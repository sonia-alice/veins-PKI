...
WaveShortMessage::WaveShortMessage(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    ...
    this->serial = 0;
    this->timestamp = 0;
    this->certSignature = "Sample Sign";
    this->msgSignature = "Sample Sign";
}
...
void WaveShortMessage::copy(const WaveShortMessage& other)
{
    ...
    this->certPublicKey = other.certPublicKey;
    this->certSignature = other.certSignature;
    this->msgSignature = other.msgSignature;
}
...
void WaveShortMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->certPublicKey);
    doParsimPacking(b,this->certSignature);
    doParsimPacking(b,this->msgSignature);
}
...
void WaveShortMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->certPublicKey);
    doParsimUnpacking(b,this->certSignature);
    doParsimUnpacking(b,this->msgSignature);
}
...
int WaveShortMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "certPublicKey")==0) return base+13;
    if (fieldName[0]=='c' && strcmp(fieldName, "certSignature")==0) return base+14;
    if (fieldName[0]=='m' && strcmp(fieldName, "msgSignature")==0) return base+15;
