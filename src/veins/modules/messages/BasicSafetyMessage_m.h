...
class BasicSafetyMessage : public ::WaveShortMessage
{
  ...
  public:
    ...
    //virtual void setCertificateV(ECDSA<ECP, SHA256>::PublicKey pubKey, std::string sign){certificateV.pkeyVehicle=pubKey, certificateV.signature=sign;}
    //ECDSA<ECP, SHA256>::PublicKey getCertPubKey();
    //std::string getCertSign(){return certificateV.signature;}
};
