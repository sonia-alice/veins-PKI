...
class WaveShortMessage : public ::omnetpp::cPacket
{
  protected:
    ...
    ECDSA<ECP, SHA256>::PublicKey certPublicKey;
    std::string certSignature;
    std::string msgSignature;
  ...
  public:
    ...
    virtual void setCertificateV(ECDSA<ECP, SHA256>::PublicKey pubKey, std::string sign){this->certPublicKey=pubKey, this->certSignature=sign;}
    virtual ECDSA<ECP, SHA256>::PublicKey getCertPublicKey(){return this->certPublicKey;}
    virtual std::string getCertSignature(){return this->certSignature;}
    virtual std::string getMsgSignature(){return this->msgSignature;}
    virtual void setCertPublicKey(ECDSA<ECP, SHA256>::PublicKey pubKey){this->certPublicKey=pubKey;}
    virtual void setCertSignature(std::string sign){this->certSignature=sign;}
    virtual void setMsgSignature(std::string sign){this->msgSignature=sign;}
};
