//
// Generated file, do not edit! Created by nedtool 5.3 from veins/modules/messages/BasicSafetyMessage.msg.
//
...
/*ECDSA<ECP, SHA256>::PublicKey BasicSafetyMessage::getCertPubKey()
{
    ECDSA<ECP, SHA256>::PublicKey pk = certificateV.pkeyVehicle;
