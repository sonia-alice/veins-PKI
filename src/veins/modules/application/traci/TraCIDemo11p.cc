...
double TraCIDemo11p::totalDuration = 0.0;
int TraCIDemo11p::totalBSMs = 0;
...
void TraCIDemo11p::onBSM(BasicSafetyMessage* bsm) {
    ...
    if(this->verifyPKSignature(bsm)) {
        ...
        //std::cout<<"Size of BSM MsgSign: "<<this->getBSMSize(bsm)<<std::endl;
    }
    else {
...
void TraCIDemo11p::finish(){
    ...
    TraCIDemo11p::printStat();
}

void TraCIDemo11p::printStat(){
