...
class TraCIDemo11p : public BaseWaveApplLayer {
	...
	protected:
		...
		//virtual ECDSA<ECP, SHA256>::PublicKey getPublicKeyCA(){return pkeyCA;}
        //virtual ECDSA<ECP, SHA256>::PublicKey getCertificatePK(){return certificate.pkeyVehicle;}
        //virtual std::string getDigitalSignature(){return certificate.signature;}
		virtual void finish();
