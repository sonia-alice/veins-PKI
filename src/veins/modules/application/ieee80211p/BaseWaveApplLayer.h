...
class BaseWaveApplLayer : public BaseApplLayer {
    ...
    protected:
        ...
        ECDSA<ECP, SHA256>::PublicKey pkeyCA;
        std::vector<ECDSA<ECP, SHA256>::PrivateKey> skeyV;
        std::vector<ECDSA<ECP, SHA256>::PublicKey> pkeyV;
        struct certS{
            ECDSA<ECP, SHA256>::PublicKey pkeyVehicle;
        ...
        BaseWaveApplLayer(){
            if(skeyV.empty()){
                ...
                FileSource fs1( "/home/sonia/private.ec.der", true /*pump all*/ );
                for (int i=0; i<55;i++){
                    k.Load( fs1 );
                    skeyV.push_back(k);
                }
            ...
            if(pkeyV.empty()){
                ...
                FileSource fs2( "/home/sonia/public.ec.der", true /*pump all*/ );
                for (int i=0; i<55;i++){
                    publicKey.Load( fs2 );
        ...
        virtual int getBSMSize(BasicSafetyMessage* bsm);
